...
git clone --depth=1 https://github.com/SaberMod/android_prebuilts_gcc_linux-x86_arm_sabermod-arm-linux-androideabi-4.9.git -b master gcc-64
echo "Done"
...
zipping() {
    cd AnyKernel || exit 1
    zip -r9 Teletubies-j6+"${CODENAME}"-arm- A11"${DATE}".zip ./*
    cd ..
}
compile
zipping
